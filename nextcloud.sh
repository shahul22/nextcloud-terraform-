...
nextcloud_url='1.2.3.4'
nextcloud_version='21.0.1'
letsencrypt_email='shahulh71@gmail.com'
db_root_password='Nahil@12345'
db_user_password='Nahil@12345'
...
# Install PHP
sudo apt-get install libapache2-mod-php php-common libapache2-mod-php php-mbstring php-xmlrpc php-soap php-apcu php-ldap php-redis php-gd php-xml php-intl php-json php-imagick php-mysql php-cli php-ldap php-zip php-curl php7.4-fpm -y
...
# Install complete
printf "\n\nInstallation complete.\nNavigate to http://${hostname} in a web browser to complete the setup wizard, before you run the optimization script.\n\n"
fi